import PropertyJsonConfig from "config/property_product_details_detail_config.json";
...
const MapItems = [
    { navpropname: "", uicomponent: "property", expand: "MainImage", exclude: ['MainImage'], func: Support.AddOrUpdateProperty }
]
        ...
        if (propertyId) {
            ...
            if (rslt.status) {
                ...
                if (property.MainImage) {
                    ...
                    item['property'].find((x) => x.key === "MainImage").value = tmp;
                }
